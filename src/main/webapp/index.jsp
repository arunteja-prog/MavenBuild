...
<html>
    ...
    <body>
        <nav class="w3-sidebar w3-bar-block w3-collapse w3-animate-left w3-card" style="z-index:3;width:250px;" id="mySidebar">
            ...
            <a class="w3-bar-item w3-button" href="#">Link 1-test1</a>
            <a class="w3-bar-item w3-button" href="#">Link 2-test2</a>
            <a class="w3-bar-item w3-button" href="#">Link 3-test3</a>
            <a class="w3-bar-item w3-button" href="#">Link 4-test4</a>
            <a class="w3-bar-item w3-button" href="#">Link 5-test5</a>
            <div>
